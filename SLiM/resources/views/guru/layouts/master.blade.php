...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('guru/css/profil.css') }}">
            ...
            <nav id="sidebar">
              <!-- <div class="float-right md-3">
                ...
                <ul class="list-unstyled components">
                      ...
                      <a href="{{ url('guru')}}" style="color: black">Home</a>
                      <br>
                      <br>
                      <img src="{{ asset('siswa/img/absensi.png') }}" class="mr-3 ml-3">
                      <a href="{{ url('guru/absensi')}}" style="color: black">Absensi</a>
                      <br>
                      <br>
                      <img src="{{ asset('siswa/img/jadwal.png') }}" class="mr-3 ml-3">
                      <a href="{{ url('guru/jadwal')}}" style="color: black">Jadwal Mengajar</a>
                      <br>
                      <br>
                      <img src="{{ asset('siswa/img/tugas.png') }}" class="mr-3 ml-3">
                      <a href="{{ url('guru/tugas')}}" style="color: black">Tugas Siswa</a>
                      <br>
                      <br>
                      ...
                      <a href="{{ url('guru/kelas')}}" style="color: black">Kelas</a>
                      <br>
                      <br>
                </ul>
            </nav>
